import 'package:gif_client/src/models/heypster/image.dart';
...
class HeypsterImages {
  ...
  factory HeypsterImages.fromJson(Map<String, dynamic> json) {
    return HeypsterImages(
      fixedHeightStill: HeypsterStillImage.fromJson(json['fixed_height_still']),
      originalStill: HeypsterStillImage.fromJson(json['original_still']),
      fixedWidth: HeypsterFullImage.fromJson(json['fixed_width']),
      fixedHeightSmallStill: json['fixed_height_small_still'] == null ||
              (json['fixed_height_small_still'] as Map<String, dynamic>).isEmpty
          ? null
          : HeypsterStillImage.fromJson(json['fixed_height_small_still']),
      fixedHeightDownsampled: json['fixed_height_downsampled'] == null ||
              (json['fixed_height_downsampled'] as Map<String, dynamic>).isEmpty
          ? null
          : HeypsterDownsampledImage.fromJson(json['fixed_height_downsampled']),
      preview: json['preview'] == null ||
              (json['preview'] as Map<String, dynamic>).isEmpty
          ? null
          : HeypsterPreviewImage.fromJson(json['preview']),
      fixedHeightSmall: json['fixed_height_small'] == null ||
              (json['fixed_height_small'] as Map<String, dynamic>).isEmpty
          ? null
          : HeypsterFullImage.fromJson(json['fixed_height_small']),
      downsizedStill: json['downsized_still'] == null ||
              (json['downsized_still'] as Map<String, dynamic>).isEmpty
          ? null
          : HeypsterStillImage.fromJson(json['downsized_still']),
      downsized: json['downsized'] == null ||
              (json['downsized'] as Map<String, dynamic>).isEmpty
          ? null
          : HeypsterDownsizedImage.fromJson(json['downsized']),
      downsizedLarge: json['downsized_large'] == null ||
              (json['downsized_large'] as Map<String, dynamic>).isEmpty
          ? null
          : HeypsterDownsizedImage.fromJson(json['downsized_large']),
      fixedWidthSmallStill: json['fixed_width_small_still'] == null ||
              (json['fixed_width_small_still'] as Map<String, dynamic>).isEmpty
          ? null
          : HeypsterStillImage.fromJson(json['fixed_width_small_still']),
      previewWebp: json['preview_webp'] == null ||
              (json['preview_webp'] as Map<String, dynamic>).isEmpty
          ? null
          : HeypsterWebPImage.fromJson(json['preview_webp']),
      fixedWidthStill: json['fixed_width_still'] == null ||
              (json['fixed_width_still'] as Map<String, dynamic>).isEmpty
          ? null
          : HeypsterStillImage.fromJson(json['fixed_width_still']),
      fixedWidthSmall: json['fixed_width_small'] == null ||
              (json['fixed_width_small'] as Map<String, dynamic>).isEmpty
          ? null
          : HeypsterFullImage.fromJson(json['fixed_width_small']),
      downsizedSmall: json['downsized_small'] == null ||
              (json['downsized_small'] as Map<String, dynamic>).isEmpty
          ? null
          : HeypsterPreviewImage.fromJson(json['downsized_small']),
      fixedWidthDownsampled: json['fixed_width_downsampled'] == null ||
              (json['fixed_width_downsampled'] as Map<String, dynamic>).isEmpty
          ? null
          : HeypsterDownsampledImage.fromJson(json['fixed_width_downsampled']),
      downsizedMedium: json['downsized_medium'] == null ||
              (json['downsized_medium'] as Map<String, dynamic>).isEmpty
          ? null
          : HeypsterPreviewImage.fromJson(json['downsized_medium']),
      original: json['original'] == null ||
              (json['original'] as Map<String, dynamic>).isEmpty
          ? null
          : HeypsterOriginalImage.fromJson(json['original']),
      fixedHeight: json['fixed_height'] == null ||
              (json['fixed_height'] as Map<String, dynamic>).isEmpty
          ? null
          : HeypsterFullImage.fromJson(json['fixed_height']),
      hd: json['hd'] == null ? null : HeypsterPreviewImage.fromJson(json['hd']),
      looping: json['looping'] == null ||
              (json['looping'] as Map<String, dynamic>).isEmpty
          ? null
          : HeypsterLoopingImage.fromJson(json['looping']),
      originalMp4: json['original_mp4'] == null ||
              (json['original_mp4'] as Map<String, dynamic>).isEmpty
          ? null
          : HeypsterPreviewImage.fromJson(json['original_mp4']),
      previewGif: json['preview_gif'] == null ||
              (json['preview_gif'] as Map<String, dynamic>).isEmpty
          ? null
          : HeypsterDownsizedImage.fromJson(json['preview_gif']),
      w480Still: json['480w_still'] == null ||
              (json['480w_still'] as Map<String, dynamic>).isEmpty
          ? null
          : HeypsterStillImage.fromJson(json['480w_still']),
    );
  }

  final HeypsterStillImage fixedHeightStill;
  final HeypsterStillImage originalStill;
  final HeypsterFullImage fixedWidth;
  final HeypsterStillImage? fixedHeightSmallStill;
  final HeypsterDownsampledImage? fixedHeightDownsampled;
  final HeypsterPreviewImage? preview;
  final HeypsterFullImage? fixedHeightSmall;
  final HeypsterStillImage? downsizedStill;
  final HeypsterDownsizedImage? downsized;
  final HeypsterDownsizedImage? downsizedLarge;
  final HeypsterStillImage? fixedWidthSmallStill;
  final HeypsterWebPImage? previewWebp;
  final HeypsterStillImage? fixedWidthStill;
  final HeypsterFullImage? fixedWidthSmall;
  final HeypsterPreviewImage? downsizedSmall;
  final HeypsterDownsampledImage? fixedWidthDownsampled;
  final HeypsterPreviewImage? downsizedMedium;
  final HeypsterOriginalImage? original;
  final HeypsterFullImage? fixedHeight;
  final HeypsterPreviewImage? hd;
  final HeypsterLoopingImage? looping;
  final HeypsterPreviewImage? originalMp4;
  final HeypsterDownsizedImage? previewGif;
  final HeypsterStillImage? w480Still;
