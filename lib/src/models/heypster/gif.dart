...
class HeypsterGif {
  ...
  factory HeypsterGif.fromJson(Map<String, dynamic> json) => HeypsterGif(
        title: json['title'],
        type: json['type'],
        id: json['id'],
        slug: json['slug'],
        ...
        user: HeypsterUser.fromJson(json['user'] as Map<String, dynamic>?),
  ...
  @override
  String toString() =>
      'HeypsterGif{title: $title, type: $type, id: $id, slug: $slug, url: $url, bitlyGifUrl: $bitlyGifUrl, bitlyUrl: $bitlyUrl, embedUrl: $embedUrl, username: $username, source: $source, rating: $rating, contentUrl: $contentUrl, sourceTld: $sourceTld, sourcePostUrl: $sourcePostUrl, isSticker: $isSticker, importDatetime: $importDatetime, trendingDatetime: $trendingDatetime, user: $user, images: $images}';

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is HeypsterGif &&
